  ...
  publish:
    ...
    steps:
      ...
      - name: publish on version change
        id: publish_nuget
        uses: rohan-buchner/publish-gh-package
        with:
          ...
          # NuGet server uri hosting the packages, defaults to https://api.nuget.org/v3/index.json
          # *  Also support GitHub Package format https://nuget.pkg.github.com/<organization>/index.json
          # NUGET_PUSH_SOURCE: https://api.nuget.org/v3/index.json
          
          # must be in the Format:
          # e.g `<source>/%PACKAGE_NAME%/index.json`
          # your string must literally contain the following "%PACKAGE_NAME%"
          # NUGET_PULL_SOURCE: `https://api.nuget.org/v3-flatcontainer/%PACKAGE_NAME%/index.json`
